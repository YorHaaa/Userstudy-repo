...
public final class Messages {
  ...
  */
  ...
  /** Defines when two exceptions are considered the "same" for deduplication of stack traces. 
   * 
   * This equivalence checks the class, message, stack trace and cause of the exception.
  ...
  */
  private static final class ThrowableEquivalence extends Equivalence<Throwable> {
     ...
     * 
     * This is used to deduplicate exceptions in error messages.
     * 
     */
   ...
   *
   * * <p>These codes are used to colorize error messages in the console, if enabled.
  ...
  /**  * These codes are used in the `FormatOptions` enum to provide reusable formatting options
   * for error messages. 
   * 
